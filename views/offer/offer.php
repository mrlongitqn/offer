<section id="tab-discover" class="section-full tab-render-item is-active section-content page-home js-tab-menu-render js-content"
         data-tab="home">
    <div class="section-switch">
        <ul class="clearfix switch">
            <li id="tab_offer" class="switch-item js-tab-target is-active" data-tab="offers">
                <i class="icons icons_setting_mn">&nbsp;</i>
                Offers
            </li>
            <li id="tab_survey" class="switch-item js-tab-target" data-tab="survey">
                <i class="icons icons_survey">&nbsp;</i>
                Survey
            </li>
            <li id="tab_video" class="switch-item js-tab-target" data-tab="video">
    ...
    <div class="container">
        ...
        <div class="swiper-container js-swiper-home">
            ...
            <ul class="swiper-wrapper">
                <!-- Slides -->
                <li class="swiper-slide"><img class="img-full" src="<?php echo BASE_URL ?>public/img/top/slider_1.png"/>
                </li>
                <li class="swiper-slide"><img class="img-full" src="<?php echo BASE_URL ?>public/img/top/slider_1.png"/>
                </li>
                <li class="swiper-slide"><img class="img-full" src="<?php echo BASE_URL ?>public/img/top/slider_1.png"/>
        ...
        <ul class="clearfix tab-render">
            <li class="clearfix tab-render-item js-tab-render is-active" data-tab="offers">
                <ul class="clearfix article" id="ul_offer">

                </ul>
                <div class="loading-info" id="loading_offer-info">
                    <img src="<?php echo BASE_URL ?>/public/img/ajax-loader.gif" />
                </div>
            </li>
            <li class="clearfix tab-render-item js-tab-render" data-tab="survey">
                <ul class="clearfix article" id="ul_survey">

                </ul>
                <div class="loading-info" id="loading_survey-info">
                    <img src="<?php echo BASE_URL ?>/public/img/ajax-loader.gif" />
                </div>
            </li>
            <li class="clearfix tab-render-item js-tab-render" data-tab="video">
                <ul class="clearfix article" id="ul_video">

                </ul>
                <div class="loading-info" id="loading_video-info">
                    <img src="<?php echo BASE_URL ?>/public/img/ajax-loader.gif" />
                </div>
            </li>
        </ul>
...
<!-- section tab Reward -->
<section class="section-full tab-render-item section-content page-reward js-tab-menu-render js-content"
         data-tab="reward">
    ...
    <div class="container">
        ...
        <div class="txt-center content">
            <p class="txt-coins">It will cost 550 coins to redeem this reward. Please enter your mail address to receive
                your Amazon gift card</p>
    ...
    <div class="summary-reuse">
        ...
        <p class="txt"><span class="dot">•</span><span class="sub">please make sure the email your enter above is correct and valid</span>
        </p>
        <p class="txt"><span class="dot">•</span><span class="sub">We’ll transferring your redeemed rewards to your account within 24 hours, please note to check.</span>
        </p>
    </div>
</section>
<!-- End section tab Reward -->
<!-- section tab Setting -->
<section class="section-full tab-render-item section-content page-setting js-tab-menu-render js-content"
         data-tab="setting">
    <div class="container">
        <div class="user">
            <ul class="user-info">
